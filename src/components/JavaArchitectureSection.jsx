  ...
  return (
    <section className="py-24 sm:py-32 px-6 sm:px-8 max-w-7xl mx-auto border-b border-white/5 relative select-none">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-stretch">
        ...
        <div className="lg:col-span-5 rounded-3xl bg-[#15161C] border border-white/10 p-6 sm:p-8 flex flex-col justify-between shadow-2xl relative overflow-hidden">
          ...
          <div className="py-6 space-y-6 flex-1 flex flex-col justify-center">
            ...
            <div className="flex justify-center">
              <div className="px-5 py-2.5 rounded-2xl bg-[#1F222E] border border-white/20 text-white font-mono font-bold text-sm shadow-xl flex items-center gap-2">
            ...
            <div className="relative flex justify-center items-center">
              <div className="w-1/2 h-4 border-t-2 border-l-2 border-r-2 border-white/20 rounded-t-lg" />
            </div>

            {/* Two Pillars: Software Engineering & Web Development */}
            <div className="grid grid-cols-2 gap-4">
              {/* Pillar 1: Software Engineering */}
              <div className="p-4 rounded-2xl bg-[#1A1C24] border border-orange-500/30 flex flex-col items-center text-center">
              ...
              <div className="p-4 rounded-2xl bg-[#1A1C24] border border-cyan-500/30 flex flex-col items-center text-center">
            ...
            <div className="p-3 rounded-xl bg-gradient-to-r from-orange-500/10 via-white/[0.03] to-cyan-500/10 border border-white/10 text-center">
        ...
        {/* ================================================================= */}
        <div className="lg:col-span-7 rounded-3xl bg-[#13141A] border border-white/10 p-6 sm:p-8 flex flex-col justify-between shadow-2xl">
          <div>
            {/* Top Workspace Bar */}
            ...
            {/* Tab Content Display */}
            <div className="py-5 font-mono text-xs leading-relaxed select-text">
              {activeTab === 'spring' && (
                <div className="space-y-2 bg-[#0E0F14] p-5 rounded-2xl border border-white/10 text-slate-300">
              ...
              {activeTab === 'dsa' && (
                <div className="space-y-2 bg-[#0E0F14] p-5 rounded-2xl border border-white/10 text-slate-300">
                  ...
                  <div className="pl-8 text-slate-300">dist[S] = 0; pq.add(<span className="text-cyan-400">new</span> Node(S, 0));</div>
                  <div className="pl-8 text-purple-400">while (!pq.isEmpty()) &#123;</div>
                  <div className="pl-12 text-slate-300">Node curr = pq.poll();</div>
                  <div className="pl-12 text-slate-400">// Relax outgoing graph edges with optimal relaxation check</div>
                  <div className="pl-8">&#125;</div>
                  <div className="pl-8 text-emerald-400">return dist;</div>
                  <div className="pl-4">&#125;</div>
                  <div>&#125;</div>
                </div>
              )}
              ...
              {activeTab === 'jvm' && (
                <div className="space-y-3 bg-[#0E0F14] p-5 rounded-2xl border border-white/10 text-slate-300">
                  <div className="text-slate-500">// JVM Runtime Environment & Backend Metrics</div>
                  <div className="grid grid-cols-2 gap-3 pt-1">
                    <div className="p-3 rounded-xl bg-white/[0.02] border border-white/10">
                      <span className="text-[10px] text-slate-400 block mb-1">JVM Engine</span>
                      <span className="text-white font-bold">OpenJDK 21 (LTS) HotSpot 64-Bit</span>
                    </div>
                    <div className="p-3 rounded-xl bg-white/[0.02] border border-white/10">
                      <span className="text-[10px] text-slate-400 block mb-1">Garbage Collector</span>
                      <span className="text-emerald-400 font-bold">G1GC Low-Latency Tuning</span>
                    </div>
                    <div className="p-3 rounded-xl bg-white/[0.02] border border-white/10">
                      <span className="text-[10px] text-slate-400 block mb-1">Concurrency Paradigm</span>
                      <span className="text-cyan-300 font-bold">Virtual Threads & ExecutorService</span>
                    </div>
                    <div className="p-3 rounded-xl bg-white/[0.02] border border-white/10">
                      <span className="text-[10px] text-slate-400 block mb-1">Connection Pool</span>
                      <span className="text-purple-300 font-bold">HikariCP High-Throughput Pool</span>
                    </div>
                  </div>
                  <div className="p-2.5 rounded-lg bg-emerald-950/30 border border-emerald-500/30 text-[11px] text-emerald-300 flex items-center justify-between">
          ...
          <div className="mt-2 p-4 rounded-2xl bg-[#1A1C24] border border-white/10 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="flex items-center gap-2.5">
              <span className="px-2 py-1 rounded bg-emerald-500/20 text-emerald-400 text-xs font-mono font-bold border border-emerald-500/30">
                POST
              </span>
