...
function TaskManagerMockup() {
  return (
    <div className="w-full h-full bg-[#111218] rounded-xl border border-white/15 p-3 sm:p-4 flex flex-col justify-between shadow-2xl font-sans text-white text-xs select-none">
      {/* Top App Header */}
      ...
      <div className="grid grid-cols-12 gap-2.5 sm:gap-3 flex-1 pt-2 sm:pt-3">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <div>
                ...
                <p className="text-[9.5px] sm:text-[10px] text-slate-400">Stay organized, get things done.</p>
              </div>
            </div>

            {/* Input Bar */}
            <div className="flex items-center gap-1.5 sm:gap-2 bg-[#181922] p-1.5 rounded-lg border border-white/10 mb-2 sm:mb-3">
              <input
                type="text"
                readOnly
                value="Build the 3D portfolio experience..."
                className="bg-transparent border-none text-[10.5px] sm:text-[11px] text-slate-300 flex-1 px-1 outline-none truncate"
              />
              <button className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium px-2 sm:px-2.5 py-1 rounded text-[9.5px] sm:text-[10px] shadow shrink-0">
                Add
              </button>
            </div>

            {/* Status Tabs */}
            <div className="flex items-center gap-1.5 mb-2 sm:mb-2.5 overflow-x-auto no-scrollbar pb-0.5">
              <span className="px-2 py-0.5 rounded-full text-[9.5px] sm:text-[10px] bg-indigo-600/30 text-indigo-200 border border-indigo-500/30 font-medium shrink-0">
                All (4)
              </span>
              <span className="px-2 py-0.5 rounded-full text-[9.5px] sm:text-[10px] text-slate-400 hover:text-white shrink-0">
                Pending
              </span>
              <span className="px-2 py-0.5 rounded-full text-[9.5px] sm:text-[10px] text-slate-400 hover:text-white shrink-0">
                In Progress
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between p-1.5 sm:p-2 rounded-lg bg-[#181924] border border-white/5 text-[10.5px] sm:text-[11px] gap-2">
                ...
                <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
                  ...
                  <span className="text-[9.5px] sm:text-[10px] text-slate-500 font-mono hidden sm:inline">Today</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-1.5 sm:p-2 rounded-lg bg-[#181924] border border-white/5 text-[10.5px] sm:text-[11px] gap-2">
                ...
                <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
                  ...
                  <span className="text-[9.5px] sm:text-[10px] text-slate-500 font-mono hidden sm:inline">Tomorrow</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-1.5 sm:p-2 rounded-lg bg-[#181924] border border-white/5 text-[10.5px] sm:text-[11px] gap-2">
                ...
                <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
                  ...
                  <span className="text-[9.5px] sm:text-[10px] text-slate-500 font-mono hidden sm:inline">Jul 25</span>
                </div>
              </div>
            </div>
          </div>
...
function ResearchPaperMockup() {
  return (
    <div className="w-full h-full bg-[#0E131F] rounded-xl border border-blue-500/20 p-3 sm:p-4 flex flex-col justify-between shadow-2xl font-sans text-white text-xs select-none">
      {/* Search Header */}
      <div className="flex items-center justify-between pb-2.5 sm:pb-3 border-b border-white/10 gap-2">
        ...
        <span className="text-[9.5px] sm:text-[10px] font-mono text-cyan-400 bg-cyan-500/10 px-2 py-0.5 rounded-full border border-cyan-500/30 shrink-0">
          ● 250M+ Works
        </span>
      </div>
      ...
      <div className="pt-2 sm:pt-3">
        <div className="flex items-center gap-1.5 sm:gap-2 bg-[#141B2D] p-1.5 sm:p-2 rounded-lg border border-cyan-500/30 mb-2 sm:mb-3 shadow-inner">
        ...
        <div className="space-y-1.5 sm:space-y-2">
          ...
          <div className="p-2 sm:p-2.5 rounded-lg bg-[#141B2D]/80 border border-white/10">
            <div className="flex items-center justify-between gap-2 mb-1">
              <span className="text-[11px] sm:text-xs font-bold text-slate-100 truncate">
      ...
      {/* Footer Metrics */}
      <div className="pt-2 border-t border-white/5 flex flex-wrap items-center justify-between gap-1 text-[9.5px] sm:text-[10px] font-mono text-slate-400">
...
function ScholarIQMockup() {
  return (
    <div className="w-full h-full bg-[#131122] rounded-xl border border-indigo-500/20 p-3 sm:p-4 flex flex-col justify-between shadow-2xl font-sans text-white text-xs select-none">
      {/* App Header */}
      <div className="flex items-center justify-between pb-2.5 sm:pb-3 border-b border-white/10 gap-2">
        <div className="flex items-center gap-2 min-w-0">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <span className="text-[9.5px] sm:text-[10px] font-mono text-purple-300 bg-purple-500/15 px-2 py-0.5 rounded-full border border-purple-500/30">
            Llama 3.3 via Groq
          </span>
        </div>
      </div>
      ...
      {/* Metric Cards Grid */}
      <div className="grid grid-cols-3 gap-1.5 sm:gap-2 pt-2 sm:pt-3">
        <div className="p-1.5 sm:p-2 rounded-lg bg-[#1B1733] border border-white/10">
          <div className="text-[9px] sm:text-[10px] text-slate-400 truncate">Rows Ingested</div>
        ...
        <div className="p-1.5 sm:p-2 rounded-lg bg-[#1B1733] border border-amber-500/30">
          <div className="text-[9px] sm:text-[10px] text-slate-400 truncate">Watchlist Alerts</div>
        ...
        <div className="p-1.5 sm:p-2 rounded-lg bg-[#1B1733] border border-white/10">
          <div className="text-[9px] sm:text-[10px] text-slate-400 truncate">Inference</div>
      ...
      <div className="space-y-1.5 sm:space-y-2 py-1.5 sm:py-2">
        <div className="p-1.5 sm:p-2 rounded-lg bg-[#1B1733]/90 border border-indigo-500/30 text-[10px] sm:text-[11px]">
          ...
          <p className="text-slate-200 line-clamp-1 sm:line-clamp-2">
        ...
        <div className="p-1.5 sm:p-2 rounded-lg bg-[#17132B] border border-white/10">
          <div className="flex items-center justify-between text-[9px] sm:text-[10px] font-mono text-slate-400 mb-1">
            <span>Dynamic AI Recharts (Bar & Line)</span>
            <span className="text-emerald-400">Live JSON Gen</span>
          </div>
          <div className="h-8 sm:h-10 flex items-end gap-1 px-2 pt-1 border-b border-white/10">
...
function StriverDSAMockup() {
  return (
    <div className="w-full h-full bg-[#16120E] rounded-xl border border-orange-500/20 p-3 sm:p-4 flex flex-col justify-between shadow-2xl font-mono text-white text-xs select-none">
      {/* IDE Header */}
      <div className="flex items-center justify-between pb-2.5 sm:pb-3 border-b border-white/10 gap-2">
        <div className="flex items-center gap-2 min-w-0">
      ...
      {/* Code Editor & Complexity Map Split: Stacks on mobile, splits on sm+ */}
      <div className="grid grid-cols-1 sm:grid-cols-12 gap-2 pt-2 sm:pt-3">
        {/* Java Algorithm Code */}
        <div className="sm:col-span-7 p-2 sm:p-2.5 rounded-lg bg-[#110E0B] border border-white/10 text-[9.5px] sm:text-[10px] font-mono leading-relaxed overflow-x-auto">
          ...
          <div className="pl-2 text-slate-300 whitespace-nowrap sm:whitespace-normal">PriorityQueue&lt;Node&gt; pq = new PriorityQueue&lt;&gt;(Comparator.comparingInt(n -&gt; n.weight));</div>
        ...
        <div className="sm:col-span-5 p-2 rounded-lg bg-[#1C1611] border border-orange-500/30 text-[9.5px] sm:text-[10px] space-y-1 sm:space-y-1.5 flex flex-col justify-between">
          <div>
            <div className="text-orange-400 font-bold text-[10px] sm:text-[11px] mb-0.5 sm:mb-1">Graph Traversal</div>
            <div className="space-y-0.5 sm:space-y-1 text-slate-300 text-[8.5px] sm:text-[9px]">
          ...
          <div className="pt-1 border-t border-white/10 flex flex-wrap gap-1">
            <span className="px-1.5 py-0.5 rounded bg-white/5 text-[8.5px] sm:text-[9px] text-slate-300">Arrays</span>
            <span className="px-1.5 py-0.5 rounded bg-white/5 text-[8.5px] sm:text-[9px] text-slate-300">Graphs</span>
            <span className="px-1.5 py-0.5 rounded bg-white/5 text-[8.5px] sm:text-[9px] text-slate-300">Trees</span>
            <span className="px-1.5 py-0.5 rounded bg-orange-500/20 text-orange-300 text-[8.5px] sm:text-[9px]">DP</span>
          </div>
        </div>
      </div>

      {/* Execution Benchmark Banner */}
      <div className="space-y-1.5 py-1.5 sm:py-2">
      ...
      {/* Footer Status */}
      <div className="pt-2 border-t border-white/5 flex flex-wrap items-center justify-between gap-1 text-[9px] sm:text-[10px]">
...
function CodeArenaMockup() {
  return (
    <div className="w-full h-full bg-[#0D1513] rounded-xl border border-emerald-500/20 p-3 sm:p-4 flex flex-col justify-between shadow-2xl font-mono text-white text-xs select-none">
      {/* IDE Header */}
      <div className="flex items-center justify-between pb-2.5 sm:pb-3 border-b border-white/10 gap-2">
        <div className="flex items-center gap-2 min-w-0">
      ...
      {/* Problem & Backend Execution Split: Stacks on mobile, splits on sm+ */}
      <div className="grid grid-cols-1 sm:grid-cols-12 gap-2 pt-2 sm:pt-3">
        {/* Backend REST Endpoint Spec */}
        <div className="sm:col-span-5 p-2 rounded-lg bg-[#13201D] border border-white/10 text-[9.5px] sm:text-[10px] space-y-1">
          ...
          <div className="text-[8.5px] sm:text-[9px] text-emerald-400/90 pt-0.5 truncate">MySQL: `submissions` table updated</div>
        </div>

        {/* Code Editor */}
        <div className="sm:col-span-7 p-2 rounded-lg bg-[#111A18] border border-white/10 text-[9.5px] sm:text-[10px] font-mono leading-relaxed overflow-x-auto">
          ...
          <div className="pl-2 text-slate-300 whitespace-nowrap sm:whitespace-normal">SubmissionDTO sub = validate(request);</div>
          <div className="pl-2 text-emerald-300 whitespace-nowrap sm:whitespace-normal">ExecutionResult res = runner.execute(sub);</div>
      ...
      <div className="space-y-1.5 py-1.5 sm:py-2">
        <div className="flex items-center justify-between p-1.5 sm:p-2 rounded-lg bg-emerald-950/40 border border-emerald-500/30 text-[9.5px] sm:text-[10px] gap-2">
          ...
          <span className="text-slate-400 shrink-0">14ms • 0 Errors</span>
        </div>
      </div>

      {/* Footer */}
      <div className="pt-2 border-t border-white/5 flex flex-wrap items-center justify-between gap-1.5 text-[9px] sm:text-[10px]">
...
function AnimeTrackerMockup() {
  return (
    <div className="w-full h-full bg-[#18150D] rounded-xl border border-amber-500/20 p-3 sm:p-4 flex flex-col justify-between shadow-2xl font-sans text-white text-xs select-none">
      {/* Android Device Status Bar */}
      <div className="flex items-center justify-between pb-2 border-b border-white/10 text-[9.5px] sm:text-[10px] font-mono text-slate-400">
        <span>09:41</span>
        ...
        <div className="p-2 sm:p-2.5 rounded-xl bg-[#241F14] border border-amber-500/30 flex items-center justify-between gap-2 shadow-lg">
          <div className="min-w-0">
            <div className="flex items-center gap-1.5 mb-0.5">
              ...
              <span className="text-[9.5px] sm:text-[10px] text-slate-400 font-mono truncate">Ep 14 Broadcast</span>
            </div>
            <h5 className="font-bold text-[11px] sm:text-xs text-white truncate">Jujutsu Kaisen: Culling Game</h5>
            <p className="text-[9.5px] sm:text-[10px] text-amber-300 font-mono mt-0.5">
              Countdown: 02h 45m 18s
            </p>
          </div>
          <button className="flex items-center gap-1 px-2 sm:px-2.5 py-1.5 rounded-lg bg-amber-500/20 text-amber-300 border border-amber-500/40 text-[9.5px] sm:text-[10px] font-mono hover:bg-amber-500 hover:text-black transition-colors shrink-0">
        ...
        <div className="p-2 sm:p-2.5 rounded-xl bg-[#241F14] border border-white/10 flex items-center justify-between gap-2">
          <div className="min-w-0">
            <div className="flex items-center gap-1.5 mb-0.5">
              ...
              <span className="text-[9.5px] sm:text-[10px] text-slate-400 font-mono truncate">Ep 22</span>
            </div>
            <h5 className="font-bold text-[11px] sm:text-xs text-white truncate">Frieren: Beyond Journey&apos;s End</h5>
            <p className="text-[9.5px] sm:text-[10px] text-slate-400 font-mono mt-0.5">
              GraphQL Synchronized
            </p>
          </div>
          <button className="flex items-center gap-1 px-2 sm:px-2.5 py-1.5 rounded-lg bg-white/5 text-slate-300 border border-white/10 text-[9.5px] sm:text-[10px] font-mono shrink-0">
...
function NoCancelPolicyMockup() {
  return (
    <div className="w-full h-full bg-[#1A0E13] rounded-xl border border-rose-500/20 p-3 sm:p-4 flex flex-col justify-between shadow-2xl font-sans text-white text-xs select-none">
      {/* Header */}
      <div className="flex items-center justify-between pb-2.5 sm:pb-3 border-b border-white/10 gap-2">
        <div className="flex items-center gap-2 min-w-0">
        ...
        <span className="text-[9.5px] sm:text-[10px] font-mono bg-rose-500/20 text-rose-300 px-2 py-0.5 rounded-full border border-rose-500/30 shrink-0">
          Anti-Flake Treaty
        </span>
      </div>

      {/* Agreement Step Card */}
      <div className="p-2.5 sm:p-3.5 rounded-xl bg-[#26141D] border border-rose-500/30 my-1 sm:my-2">
        <div className="flex items-center justify-between mb-1.5 sm:mb-2">
          <span className="text-[9px] sm:text-[10px] font-mono text-rose-300 uppercase">
            Step 3 of 4: Commitment
          </span>
          <span className="text-[9px] sm:text-[10px] font-mono text-slate-400">Ratification: 80%</span>
        </div>
        ...
        <div className="space-y-1.5 sm:space-y-2">
          <div className="p-1.5 sm:p-2 rounded-lg bg-rose-500/20 border border-rose-400 text-rose-200 text-[10.5px] sm:text-xs flex items-center justify-between gap-1 font-medium">
            ...
            <span className="text-[9px] sm:text-[10px] font-mono bg-rose-500 text-white px-1.5 py-0.5 rounded shrink-0">
              Selected
            </span>
          </div>
          <div className="p-1.5 sm:p-2 rounded-lg bg-black/40 border border-white/10 text-slate-400 text-[10.5px] sm:text-xs flex items-center justify-between gap-1 opacity-80">
            ...
            <span className="text-[9px] sm:text-[10px] font-mono text-slate-500 shrink-0">Fine Clause</span>
          </div>
        </div>
      </div>
...
function AutoFileOrganizerMockup() {
  return (
    <div className="w-full h-full bg-[#0C1417] rounded-xl border border-teal-500/20 p-3 sm:p-4 flex flex-col justify-between shadow-2xl font-mono text-white text-xs select-none">
      ...
      <div className="flex items-center justify-between pb-2.5 sm:pb-3 border-b border-white/10 gap-2">
        ...
        <span className="text-[9.5px] sm:text-[10px] text-teal-400 bg-teal-500/15 px-2 py-0.5 rounded border border-teal-500/30 shrink-0">
          Watchdog Active
        </span>
      </div>

      {/* Terminal Stream Logs */}
      <div className="space-y-1 sm:space-y-1.5 py-1.5 sm:py-2 text-[9px] sm:text-[10px] leading-relaxed text-slate-300 overflow-x-auto">
        <div className="text-slate-400 whitespace-nowrap sm:whitespace-normal">
          $ python3 auto_organizer.py --watch ~/Downloads --background
        </div>
        <div className="text-teal-400 whitespace-nowrap sm:whitespace-normal">
          [WATCHDOG 21:04:10] Inotify observer initialized on 12 subdirectories.
        </div>
        <div className="text-slate-200 whitespace-nowrap sm:whitespace-normal">
          [EVENT] New file: <span className="text-cyan-300">Q3_financial_model.xlsx</span>
        </div>
        <div className="text-emerald-400 pl-3 sm:pl-4 whitespace-nowrap sm:whitespace-normal">
      ...
      {/* Telemetry Summary */}
      <div className="pt-2 border-t border-white/5 flex flex-wrap items-center justify-between gap-1 text-[9.5px] sm:text-[10px] text-slate-400">
...
function CodeSnippetView({ project }) {
  return (
    <div className="w-full h-full bg-[#101116] rounded-xl border border-white/10 p-3 sm:p-4 flex flex-col justify-between font-mono text-xs text-slate-300 select-none shadow-2xl">
      ...
      <div className="space-y-1 text-[10px] sm:text-[11px] leading-relaxed py-1.5 sm:py-2 overflow-x-auto">
        <div className="text-slate-400">// Project: {project.title} ({project.year})</div>
        <div className="text-cyan-400 whitespace-nowrap sm:whitespace-normal">import <span className="text-white">{'{'} useState, useEffect {'}'}</span> from <span className="text-amber-300">&apos;react&apos;</span>;</div>
        <div className="text-purple-400 whitespace-nowrap sm:whitespace-normal">export default function <span className="text-emerald-400">{project.slug.replace(/-/g, '')}Module</span>() {'{'}</div>
        <div className="pl-3 sm:pl-4 text-slate-300 whitespace-nowrap sm:whitespace-normal">const [data, setData] = useState(initialState);</div>
        <div className="pl-3 sm:pl-4 text-purple-400 whitespace-nowrap sm:whitespace-normal">useEffect(() =&gt; {'{'}</div>
        <div className="pl-6 sm:pl-8 text-cyan-300 whitespace-nowrap sm:whitespace-normal">const subscription = orchestrateLifecycle(data);</div>
        <div className="pl-6 sm:pl-8 text-slate-400 whitespace-nowrap sm:whitespace-normal">return () =&gt; subscription.teardown();</div>
        <div className="pl-3 sm:pl-4 text-purple-400 whitespace-nowrap sm:whitespace-normal">{'}'}, [data]);</div>
        <div className="pl-3 sm:pl-4 text-emerald-400 whitespace-nowrap sm:whitespace-normal">return &lt;InteractiveExperience telemetry={'{'}data{'}'} /&gt;;</div>
...
function TelemetryView({ project }) {
  return (
    <div className="w-full h-full bg-[#101116] rounded-xl border border-white/10 p-3 sm:p-4 flex flex-col justify-between font-mono text-xs text-slate-300 select-none shadow-2xl">
      ...
      <div className="space-y-1.5 sm:space-y-2 py-1.5 sm:py-2 text-[10px] sm:text-[11px]">
